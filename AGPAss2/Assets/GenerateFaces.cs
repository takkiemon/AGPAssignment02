...
public class GenerateFaces : MonoBehaviour
{
    ...
    public void RebuildMesh()
    {
        ...
        circleVertexArray = new Vector3[2 * (1 + resolution)];//these are the verteces used for the circle faces
        sideVertexArray = new Vector3[2 * resolution];//these are the verteces used for the face wrapping the cylinder 
